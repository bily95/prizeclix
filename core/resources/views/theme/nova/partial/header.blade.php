                ...
                <div class="main-header-left">
                    ...
                    <div class="responsive-logo">
                      <a href="{{ route('welcome') }}" class="header-logo">
                          <img src="{{ asset('asset/uploads/setting/' . set('siteSmallLogoImage')) }}"
                ...
                <div class="main-header-right">
                    ...
                    <div class="navbar navbar-nav-right responsive-navbar navbar-dark mb-0 p-0">
                        <ul class="nav nav-item header-icons navbar-nav-right ms-auto">
                            ...
                            @guest
                                @include(SETTING['site_theme'] . 'partial.guset-header')
                            @endguest
                            @auth
                                @include(SETTING['site_theme'] . 'partial.auth-header')
                            @endauth
        ...
        <div class="sticky">
            <aside class="app-sidebar">
                <div class="main-sidebar-header active">
                    <a class="header-logo active" href="{{ route('welcome') }}">
                        <img src="{{ asset('asset/uploads/setting/' . SETTING['siteSmallLogoImage']) }}"
                ...
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu navbar-menu">
                        ...
                        <li class="slide">
                            <a class="side-menu__item" href="{{ route('user.leaderboard') }}">
                        ...
                        <li class="slide">
                            <a class="side-menu__item" href="{{ auth()->check() ? '#' : route('user.login') }}"
                                @auth

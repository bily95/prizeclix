...
class UserAgent
{
    ...
    const BROWSER_BRAVE = 'Brave'; // http://www.opera.com/
    const BROWSER_PALEMOON = 'Palemoon'; // http://www.opera.com/mini/
    const BROWSER_ICEWEASEL = 'Iceweasel'; // http://www.webtv.net/pc/
    const BROWSER_SHIRETOKO = 'Shiretoko'; // https://www.microsoft.com/edge
    const BROWSER_MOZILLA = 'Mozilla'; // http://www.microsoft.com/ie/
    const BROWSER_AMAYA = 'Amaya'; // http://en.wikipedia.org/wiki/Internet_Explorer_Mobile
    const BROWSER_LYNX = 'Lynx'; // http://www.konqueror.org/
    const BROWSER_SAFARI = 'Safari'; // http://www.icab.de/
    const BROWSER_IPHONE = 'iPhone'; // http://www.omnigroup.com/applications/omniweb/
    const BROWSER_IPOD = 'iPod'; // http://www.ibphoenix.com/
    const BROWSER_IPAD = 'iPad'; // https://www.mozilla.org/en-US/firefox/
    const BROWSER_CHROME = 'Chrome'; // https://brave.com/
    const BROWSER_ANDROID = 'Android'; // https://www.palemoon.org/
    const BROWSER_GOOGLEBOT = 'GoogleBot'; // http://www.geticeweasel.org/
    const BROWSER_CURL = 'cURL'; // http://wiki.mozilla.org/Projects/shiretoko
    const BROWSER_WGET = 'Wget'; // http://www.mozilla.com/en-US/
    const BROWSER_UCBROWSER = 'UCBrowser'; // http://www.w3.org/Amaya/
    const BROWSER_YANDEXBOT = 'YandexBot'; // http://en.wikipedia.org/wiki/Lynx
    const BROWSER_YANDEXIMAGERESIZER_BOT = 'YandexImageResizer'; // http://apple.com
    const BROWSER_YANDEXIMAGES_BOT = 'YandexImages'; // http://apple.com
    const BROWSER_YANDEXVIDEO_BOT = 'YandexVideo'; // http://apple.com
    const BROWSER_YANDEXMEDIA_BOT = 'YandexMedia'; // http://apple.com
    const BROWSER_YANDEXBLOGS_BOT = 'YandexBlogs'; // http://www.google.com/chrome
    const BROWSER_YANDEXFAVICONS_BOT = 'YandexFavicons'; // http://www.android.com/
    const BROWSER_YANDEXWEBMASTER_BOT = 'YandexWebmaster'; // http://en.wikipedia.org/wiki/Googlebot
    const BROWSER_YANDEXDIRECT_BOT = 'YandexDirect'; // https://en.wikipedia.org/wiki/CURL
    const BROWSER_YANDEXMETRIKA_BOT = 'YandexMetrika'; // https://en.wikipedia.org/wiki/Wget
    const BROWSER_YANDEXNEWS_BOT = 'YandexNews'; // https://www.ucweb.com/
    const BROWSER_YANDEXCATALOG_BOT = 'YandexCatalog'; // http://yandex.com/bots
    const BROWSER_SLURP = 'Yahoo! Slurp'; // http://yandex.com/bots
    const BROWSER_W3CVALIDATOR = 'W3C Validator'; // http://yandex.com/bots
    const BROWSER_BLACKBERRY = 'BlackBerry'; // http://yandex.com/bots
    const BROWSER_ICECAT = 'IceCat'; // http://yandex.com/bots
    const BROWSER_NOKIA_S60 = 'Nokia S60 OSS Browser'; // http://yandex.com/bots
    const BROWSER_NOKIA = 'Nokia Browser'; // http://yandex.com/bots
    const BROWSER_MSN = 'MSN Browser'; // http://yandex.com/bots
    const BROWSER_MSNBOT = 'MSN Bot'; // http://yandex.com/bots
    const BROWSER_BINGBOT = 'Bing Bot'; // http://yandex.com/bots
    const BROWSER_VIVALDI = 'Vivaldi'; // http://yandex.com/bots
    const BROWSER_YANDEX = 'Yandex'; // http://yandex.com/bots
    const BROWSER_NETSCAPE_NAVIGATOR = 'Netscape Navigator'; // http://en.wikipedia.org/wiki/Yahoo!_Slurp
    const BROWSER_GALEON = 'Galeon'; // http://validator.w3.org/
    const BROWSER_NETPOSITIVE = 'NetPositive'; // http://www.blackberry.com/
    const BROWSER_PHOENIX = 'Phoenix'; // http://en.wikipedia.org/wiki/GNU_IceCat
    const BROWSER_PLAYSTATION = "PlayStation"; // http://en.wikipedia.org/wiki/Web_Browser_for_S60
    const BROWSER_SAMSUNG = "SamsungBrowser"; // * all other WAP-based browsers on the Nokia Platform
    const BROWSER_SILK = "Silk"; // http://explorer.msn.com/
    const BROWSER_I_FRAME = "Iframely"; // http://search.msn.com/msnbot.htm
    const BROWSER_COCOA = "CocoaRestClient"; // http://en.wikipedia.org/wiki/Bingbot
    const PLATFORM_UNKNOWN = 'unknown'; // https://vivaldi.com/
    const PLATFORM_WINDOWS = 'Windows'; // https://browser.yandex.ua/
    const PLATFORM_WINDOWS_CE = 'Windows CE'; // http://browser.netscape.com/ (DEPRECATED)
    const PLATFORM_APPLE = 'Apple'; // http://galeon.sourceforge.net/ (DEPRECATED)
    const PLATFORM_LINUX = 'Linux'; // http://en.wikipedia.org/wiki/NetPositive (DEPRECATED)
    const PLATFORM_OS2 = 'OS/2'; // http://en.wikipedia.org/wiki/History_of_Mozilla_Firefox (DEPRECATED)
     ...
     *
     * go throw the types of the devices and return the user's device

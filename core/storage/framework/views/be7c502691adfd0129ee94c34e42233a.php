...
<footer class="footer main-footer">
        ...
        <div class="container pb-1">
            <div class="row">
                <div class="col-xl-3 col-md-4 col-6">
                    ...
                    <a href="https://play.google.com/store/apps/details?id=com.<?php echo e(SETTING['siteName']); ?>.twa" target="_blank">
                ...
                <div class="col-xl-3 col-md-4 col-6">
                    <div class="widget my-2">
                        ...
                        <div class="links-group">
                            <a href="<?php echo e(route('faq')); ?>" class="footer-link mt-2" class="paraff">
                                <i class="fas fa-question-circle"></i>
                                Faq
                            </a>
                            <a href="<?php echo e(route('tos')); ?>" class="footer-link mt-2" class="paraff">
                                <i class="fas fa-info-circle"></i>
                                Terms of Service
                            </a>
                            <a href="<?php echo e(route('policy')); ?>" class="footer-link mt-2" class="paraff">
                                <i class="fas fa-info-circle"></i>
                                Privacy Policy
                            </a>
                ...
                <div class="col-xl-3 col-md-4 col-6">
                    <div class="widget my-2">
                        ...
                        <div class="links-group">
                            <a href="https://www.trustpilot.com/review/<?php echo e(SETTING['siteName']); ?>.com" target="_blank" class="footer-link mt-2">
                                <i class="fas fa-star"></i>
                                Trustpilot
                            </a>
                            <a href="https://t.me/<?php echo e(SETTING['siteName']); ?>" target="_blank" class="footer-link mt-2">
    ...
    <div class="container">
        <div class="copy-right mt-2 text-center">
            <p style="letter-spacing:3px;opacity: .8;font-size: 10px;"><?php echo app('translator')->get('All Rights Reserved'); ?> &copy;<?php echo e(date('Y')); ?>

                <?php echo e(SETTING['siteName']); ?></p>
        </div>
    </div>
</footer>
<div class="mobile_nav">
    <ul class="mobile_nav-manu">
        <li class="mobile_nav-item">
            <a class="mobile_nav-link" href="<?php echo e(route('user.leaderboard')); ?>">
        ...
        <li class="mobile_nav-item">
            <a class="mobile_nav-link" href="<?php echo e(route('user.withdraw')); ?>">
        ...
        <li class="mobile_nav-item mobile_nav-middle">
            <a class="mobile_nav-link" href="<?php echo e(route('user.home')); ?>">
        ...
        <li class="mobile_nav-item">
            <a class="mobile_nav-link" href="<?php echo e(auth()->check() ? '#' : route('user.login')); ?>" <?php if(auth()->guard()->check()): ?>
...
<?php if(Route::has('dailytasks') && auth()->check()): ?>
    <?php echo $__env->make('dailytasks::holder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
...
<script src="<?php echo e(asset('/asset/theme/nova/js/app.min.js')); ?>"></script>
    ...
    <?php if(auth()->guard()->check()): ?>
        function showUserBalanceInDollar() {
            if ($('#flexSwitchCheckDefault').is(':checked')) {
                $('#userHeaderBalance').text('<?php echo e('$' . showAmount(auth()->user()->balance / GENERAL_SETTING['cur_rate'], 0)); ?>');
            } else {
                $('#userHeaderBalance').text('<?php echo e(GENERAL_SETTING['cur_sym']); ?><?php echo e(showAmount(auth()->user()->balance, 0)); ?>');
            }
        }
    <?php endif; ?>
</script>
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            type: "GET",
            dataType: "Json",
            url: "<?php echo e(route('api.load-sidebar-category')); ?>",
...
<script>
    function UserPublicProfile($userId)
    {
        ...
        $.ajax({
            url:"<?php echo e(route('userPublicProfile')); ?>",
            data:{
                userId:$userId,
            },
            success:function(res){
...
<?php /**PATH D:\workspace\v1Xapps30-11\core\resources\views/theme/nova/partial/footer.blade.php ENDPATH**/ ?>
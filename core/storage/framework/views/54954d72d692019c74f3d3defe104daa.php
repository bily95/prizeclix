<?php $__env->startPush('style'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('/asset/static/carsoul/bxslider.css')); ?>">
    <style>
        .bx-wrapper {
...
<?php $__env->startPush('script'); ?>
    <script src="<?php echo e(asset('/asset/static/carsoul/bxslider.min.js')); ?>"></script>
    <script src="<?php echo e(asset('/asset/static/carsoul/lazysizes.min.js')); ?>" async=""></script>
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', 'a.offerClick', function(e) {
                ...
                //console.log($id);
                $.ajax({
                    url: "<?php echo e(route('user.offer-network.details')); ?>",
                    data: {
                        id: $id
                    },
                    dataType: "json",
    ...
    <?php if(isset($category->id) && isset($offers)): ?>
        <script>
            var nextPage = <?php echo e($offers->currentPage() + 1); ?>;
            var lastPage = <?php echo e($offers->lastPage()); ?>;
            ...
            function loadMoreOffers() {
                if (nextPage <= lastPage) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('user.offer-network.browse', [$category->id, $category->name])); ?>',
                        data: {
                            page: nextPage,
            ...
            $(document).ready(function() {
                ...
                $('input[type="search"]').on('input', function() {
                    ...
                    debounceTimer = setTimeout(function() {
                        ...
                        $.ajax({
                            url: "<?php echo e(route('user.offer-network.index')); ?>",
                            data: {
                                name: name,
                            },
                            success: function(data) {
    ...
    <?php endif; ?>
<?php $__env->stopPush(); ?>
<?php /**PATH D:\workspace\v1Xapps30-11\core\Modules/OffersNetwork\Resources/views/user/asset.blade.php ENDPATH**/ ?>
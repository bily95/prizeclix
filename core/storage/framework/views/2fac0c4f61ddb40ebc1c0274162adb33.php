    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="<?php echo e(route('moder.manage-site.cron')); ?>">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
} elseif ($_instance->childHasBeenRendered('fFjR2dP')) {
    $componentId = $_instance->getRenderedChildComponentId('fFjR2dP');
    $componentTag = $_instance->getRenderedChildComponentTagName('fFjR2dP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fFjR2dP');
} else {
    $response = \Livewire\Livewire::mount('loader', []);
    $html = $response->html();
    $_instance->logRenderedChild('fFjR2dP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('FmUBGrP')) {
    $componentId = $_instance->getRenderedChildComponentId('FmUBGrP');
    $componentTag = $_instance->getRenderedChildComponentTagName('FmUBGrP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('FmUBGrP');
} else {
    $response = \Livewire\Livewire::mount('toasts', []);
    $html = $response->html();
    $_instance->logRenderedChild('FmUBGrP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\workspace\v1Xapps30-11\core\resources\views/admin/layout/primary.blade.php ENDPATH**/ ?>
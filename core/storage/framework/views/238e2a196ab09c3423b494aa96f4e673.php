    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="<?php echo e(route('moder.manage-site.cron')); ?>" class="btn btn-primary">Go to CronJobs</a>
        </div>
      </div>
    </div>
  </div>
...
<?php /**PATH D:\workspace\v1Xapps30-11\core\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
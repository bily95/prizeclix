<div id="laravel-livewire-loader" class="fade position-fixed start-0 end-0 bottom-0 text-center mb-3 pe-none"
    style="z-index: 1090;" data-show-delay="<?php echo e(config('laravel-livewire-loader.show_delay')); ?>">
    ...
    <style>
        #laravel-livewire-loader svg {
            -webkit-animation: spin <?php echo e(config('laravel-livewire-loader.animation_speed')); ?>ms linear infinite;
            -moz-animation: spin <?php echo e(config('laravel-livewire-loader.animation_speed')); ?>ms linear infinite;
            animation: spin <?php echo e(config('laravel-livewire-loader.animation_speed')); ?>ms linear infinite;
        }
...
<?php /**PATH /home/xapphfem/v1.xapps.store/core/resources/views/vendor/laravel-livewire-loader/loader.blade.php ENDPATH**/ ?>
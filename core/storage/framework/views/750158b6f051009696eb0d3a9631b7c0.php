...
} elseif ($_instance->childHasBeenRendered('g5D3Rls')) {
    $componentId = $_instance->getRenderedChildComponentId('g5D3Rls');
    $componentTag = $_instance->getRenderedChildComponentTagName('g5D3Rls');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('g5D3Rls');
} else {
    $response = \Livewire\Livewire::mount('live-state');
    $html = $response->html();
    $_instance->logRenderedChild('g5D3Rls', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('AmYGC7A')) {
    $componentId = $_instance->getRenderedChildComponentId('AmYGC7A');
    $componentTag = $_instance->getRenderedChildComponentTagName('AmYGC7A');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AmYGC7A');
} else {
    $response = \Livewire\Livewire::mount('live-chat');
    $html = $response->html();
    $_instance->logRenderedChild('AmYGC7A', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
            ...
            <!-- /breadcrumb -->
<?php /**PATH D:\workspace\v1Xapps30-11\core\resources\views/theme/nova/partial/header.blade.php ENDPATH**/ ?>